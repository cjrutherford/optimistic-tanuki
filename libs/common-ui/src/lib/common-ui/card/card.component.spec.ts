...
describe('CardComponent', () => {
    ...
    themeServiceMock = {
      themeColors$: of({
        ...
        complementaryGradients: {
          ...
          fastCycle: 'fast-complementary-cycle',
        },
        tertiary: '#123456',
        tertiaryShades: [
          ['0', '#123'],
  ...
  it('should apply default variant styles on init', () => {
    component.CardVariant = 'default';
  ...
  it('should apply gradient-glow variant styles', () => {
    component.CardVariant = 'gradient-glow';
    component.ngOnChanges({
      CardVariant: {
        currentValue: 'gradient-glow',
