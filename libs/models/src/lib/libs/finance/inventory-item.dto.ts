...
export class InventoryItemDto {
  ...
  @ApiProperty({ description: 'The ID of the user who owns the inventory item' })
  @IsString()
  @IsUUID()
  @IsNotEmpty()
  userId: string;

  @ApiProperty({ description: 'The ID of the profile associated with the inventory item' })
  @IsString()
  @IsUUID()
  @IsNotEmpty()
  profileId: string;
