...
export function generateTertiaryColor(
  ...
  // Shift hue towards blue (around 240° in HSL color wheel)
  h = (h + 0.66) % 1; // Adding 0.66 approximates a 240° shift (2/3 of the circle)
...
export function generateSuccessColor(
  baseColor: string,
...
export function generateDangerColor(
  baseColor: string,
  saturationFactor = 0.3,
  lightnessFactor = 0.2
): string {
...
export function generateWarningColor(
  baseColor: string,
  saturationFactor = 0.3,
  lightnessFactor = 0.2
): string {
