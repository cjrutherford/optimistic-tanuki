...
> = {
  classic: {
    ...
    buttonHover:
      'linear-gradient(128deg, #4057bd 0%, #5f77d1 52%, #8799df 100%)',
    cardHeader:
      'linear-gradient(180deg, #3042a5 0%, #4f67bf 60%, #6f84d4 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(34, 53, 112, 0.56) 0%, rgba(45, 66, 140, 0.46) 52%, rgba(61, 83, 160, 0.38) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(80, 108, 210, 0.42) 0%, rgba(80, 108, 210, 0.18) 45%, transparent 76%)',
    surfaceElevated:
      'linear-gradient(165deg, #ffffff 0%, #f5f8ff 56%, #edf2fb 100%)',
  },
  minimal: {
    ...
    modalOverlay:
      'linear-gradient(to bottom, rgba(10, 10, 10, 0.52) 0%, rgba(20, 20, 20, 0.44) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(15, 15, 15, 0.24) 0%, rgba(15, 15, 15, 0.08) 45%, transparent 80%)',
    surfaceElevated:
      'linear-gradient(180deg, #ffffff 0%, #f9f9f9 62%, #f0f0f0 100%)',
  },
  bold: {
    primary:
      'linear-gradient(112deg, #ff2d00 0%, #ff5e00 30%, #ff7f3a 64%, #ffc107 100%)',
    ...
    animated:
      'linear-gradient(95deg, #ff2d00, #ff6a00, #ff9a00, #00d66f, #00e5ff)',
    buttonHover:
      'linear-gradient(120deg, #ff5000 0%, #ff7a00 44%, #ffba00 100%)',
    cardHeader:
      'linear-gradient(180deg, #ff6b00 0%, #ff4200 58%, #da1a00 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(94, 25, 0, 0.56) 0%, rgba(152, 40, 0, 0.44) 46%, rgba(40, 60, 10, 0.34) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(255, 110, 20, 0.48) 0%, rgba(255, 60, 0, 0.24) 38%, transparent 76%)',
    surfaceElevated:
      'linear-gradient(158deg, #fff8eb 0%, #ffe7c7 52%, #ffd6a7 100%)',
  },
  soft: {
    ...
    buttonHover:
      'linear-gradient(142deg, #fbc5e0 0%, #e6b7ef 50%, #c2ccf8 100%)',
    cardHeader:
      'linear-gradient(180deg, #f6d8ea 0%, #eecdf0 60%, #ddd9f9 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(133, 88, 131, 0.42) 0%, rgba(150, 105, 170, 0.30) 56%, rgba(120, 130, 190, 0.24) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(223, 177, 232, 0.44) 0%, rgba(198, 214, 255, 0.24) 46%, transparent 80%)',
    surfaceElevated:
      'linear-gradient(165deg, #ffffff 0%, #fef8fc 54%, #f5f2fd 100%)',
  },
  professional: {
    ...
    buttonHover:
      'linear-gradient(128deg, #1d60ba 0%, #2b79d4 54%, #4a8fdf 100%)',
    cardHeader: 'linear-gradient(180deg, #edf3f9 0%, #dfe9f2 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(20, 45, 78, 0.54) 0%, rgba(28, 62, 106, 0.46) 56%, rgba(40, 80, 130, 0.34) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(45, 113, 203, 0.40) 0%, rgba(45, 113, 203, 0.17) 46%, transparent 80%)',
    surfaceElevated:
      'linear-gradient(164deg, #ffffff 0%, #f3f7fb 56%, #e7edf4 100%)',
  },
  playful: {
    primary:
      'linear-gradient(106deg, #ff3a95 0%, #ff5d66 30%, #ff9a2f 62%, #ffe74a 100%)',
    ...
    animated:
      'linear-gradient(90deg, #ff3a95, #ff6f61, #ffb347, #00d9ff, #64ff8f, #b56dff)',
    buttonHover:
      'linear-gradient(112deg, #ff4f9c 0%, #ff7f5c 42%, #ffd24f 100%)',
    cardHeader:
      'linear-gradient(180deg, #ffe36e 0%, #ff9a7a 52%, #ff5fbf 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(118, 32, 91, 0.50) 0%, rgba(196, 74, 74, 0.34) 44%, rgba(44, 110, 146, 0.26) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(255, 90, 130, 0.44) 0%, rgba(0, 224, 255, 0.24) 45%, transparent 80%)',
    surfaceElevated:
      'linear-gradient(160deg, #ffffff 0%, #fff8d9 58%, #ffefd0 100%)',
  },
  elegant: {
    ...
    buttonHover:
      'linear-gradient(140deg, #5e382d 0%, #815948 50%, #b3885d 100%)',
    cardHeader:
      'linear-gradient(180deg, #e8d3b3 0%, #cda472 54%, #a3794f 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(42, 28, 24, 0.58) 0%, rgba(70, 47, 37, 0.44) 52%, rgba(96, 70, 49, 0.34) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(154, 118, 83, 0.42) 0%, rgba(154, 118, 83, 0.19) 46%, transparent 80%)',
    surfaceElevated:
      'linear-gradient(160deg, #ffffff 0%, #f8f1e6 58%, #eddfc9 100%)',
  },
  architect: {
    primary:
      'repeating-linear-gradient(135deg, #121212 0 16px, #2a2a2a 16px 32px, #3f3f3f 32px 48px)',
    ...
    animated:
      'repeating-linear-gradient(120deg, #161616 0 14px, #2d2d2d 14px 28px, #ff5b2f 28px 42px, #556a76 42px 56px)',
    buttonHover:
      'repeating-linear-gradient(120deg, #202020 0 12px, #343434 12px 24px, #ff5c2f 24px 36px)',
    cardHeader:
      'linear-gradient(180deg, #343434 0%, #262626 64%, #1b1b1b 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(8, 8, 8, 0.72) 0%, rgba(26, 26, 26, 0.62) 52%, rgba(45, 32, 26, 0.52) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(255, 93, 47, 0.46) 0%, rgba(255, 93, 47, 0.18) 42%, transparent 80%)',
    surfaceElevated:
      'linear-gradient(156deg, #2c2c2c 0%, #222222 52%, #181818 100%)',
  },
  'soft-touch': {
    ...
    buttonHover:
      'linear-gradient(140deg, #ffcab7 0%, #ffb49a 50%, #eacdb8 100%)',
    cardHeader:
      'linear-gradient(180deg, #ffe9df 0%, #f6dacd 56%, #eacdc0 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(116, 78, 68, 0.42) 0%, rgba(153, 106, 92, 0.30) 56%, rgba(118, 134, 126, 0.24) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(255, 188, 164, 0.42) 0%, rgba(194, 230, 222, 0.24) 48%, transparent 82%)',
    surfaceElevated:
      'linear-gradient(164deg, #ffffff 0%, #fff7f2 54%, #f5ece2 100%)',
  },
  electric: {
    primary:
      'linear-gradient(104deg, #ff006a 0%, #ff2d95 26%, #ff6a00 58%, #ffe000 100%)',
    ...
    animated:
      'linear-gradient(88deg, #ff006a, #ff2d95, #ff6a00, #ffe000, #00e5ff, #7f5bff)',
    buttonHover:
      'linear-gradient(112deg, #ff2a7d 0%, #ff7a2f 46%, #ffd93f 100%)',
    cardHeader:
      'linear-gradient(180deg, #2f0a48 0%, #4f0d74 46%, #7b1097 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(19, 6, 33, 0.74) 0%, rgba(43, 10, 72, 0.64) 46%, rgba(80, 18, 120, 0.52) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(255, 52, 139, 0.50) 0%, rgba(0, 224, 255, 0.28) 48%, transparent 82%)',
    surfaceElevated:
      'linear-gradient(158deg, #251035 0%, #31164a 56%, #3f1d5d 100%)',
  },
  'control-center': {
    ...
    animated:
      'linear-gradient(95deg, #00a8bf, #00d2ff, #7cb342, #ffb300, #00e5ff)',
    buttonHover:
      'linear-gradient(122deg, #00b8cf 0%, #00dcff 52%, #78c8ff 100%)',
    cardHeader:
      'linear-gradient(180deg, #102137 0%, #16324f 58%, #1c4469 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(7, 13, 25, 0.74) 0%, rgba(13, 27, 48, 0.64) 50%, rgba(20, 46, 80, 0.52) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(0, 210, 255, 0.44) 0%, rgba(0, 210, 255, 0.18) 44%, transparent 82%)',
    surfaceElevated:
      'linear-gradient(160deg, #15253f 0%, #193153 56%, #1d3e66 100%)',
  },
  foundation: {
    ...
    buttonHover:
      'linear-gradient(132deg, #2b84dd 0%, #4ea0ea 56%, #77bdf4 100%)',
    cardHeader: 'linear-gradient(180deg, #eef4f8 0%, #e3edf4 100%)',
    modalOverlay:
      'linear-gradient(to bottom, rgba(16, 42, 74, 0.52) 0%, rgba(25, 63, 106, 0.40) 54%, rgba(38, 85, 137, 0.28) 100%)',
    inputFocus:
      'radial-gradient(circle at 50% 50%, rgba(68, 145, 219, 0.38) 0%, rgba(68, 145, 219, 0.16) 46%, transparent 82%)',
    surfaceElevated:
...
function buildPersonalityGradientTheme(
  ...
  return {
    ...
    secondary: `linear-gradient(${
      recipe.secondaryAngle
    }, ${secondaryBase} 0%, ${mixHex(
      secondaryBase,
      tertiaryBase,
      0.35
    )} 54%, ${secondarySoft} 100%)`,
    tertiary: `linear-gradient(${
      recipe.tertiaryAngle
    }, ${tertiaryBase} 0%, ${mixHex(
      tertiaryBase,
      accentBase,
      0.25
    )} 50%, ${tertiarySoft} 100%)`,
    ...
    cardHeader: `linear-gradient(180deg, ${mixHex(
      accentDeep,
      surfaceTop,
      0.2
    )} 0%, ${mixHex(accentBase, surfaceMid, 0.45)} 60%, ${surfaceMid} 100%)`,
...
export function normalizePersonalityId(personalityId: string): string {
  return (personalityId || '').trim().toLowerCase().replace(/\s+/g, '-');
}
