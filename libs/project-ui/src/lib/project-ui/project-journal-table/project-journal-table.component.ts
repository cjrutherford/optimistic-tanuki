...
export class ProjectJournalTableComponent implements OnInit, OnChanges {
  ...
  @Output() createJournalEntry: EventEmitter<CreateProjectJournal> =
    new EventEmitter<CreateProjectJournal>();
  @Output() editJournalEntry: EventEmitter<ProjectJournal> =
    new EventEmitter<ProjectJournal>();
  @Output() deleteJournalEntry: EventEmitter<string> =
  ...
  @Input() journals: ProjectJournal[] = [
    {
      ...
      profileId: 'profile-1',
      content:
        'Initial project setup completed. This is a very long content entry that should overflow the cell to demonstrate how overflow is handled in the table component. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
      createdAt: new Date('2024-06-01'),
      analysis:
        'Project is on track, but there are several considerations to keep in mind. The analysis section is intentionally verbose and lengthy to ensure it overflows the cell. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.',
    ...
    },
    {
      ...
      profileId: 'profile-2',
      content:
        'First sprint planning meeting held. The discussion was extensive and covered many topics, including backlog grooming, sprint goals, and resource allocation. This content is intentionally long to cause overflow in the table cell.',
      createdAt: new Date('2024-06-02'),
      analysis:
        'Team is aligned on goals, but there are some risks identified. This analysis is also intentionally long to demonstrate overflow behavior in the UI. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae.',
    ...
    },
    {
      ...
      profileId: 'profile-1',
      content:
        'Design phase completed. The documentation and diagrams are comprehensive and detailed, spanning multiple pages. This content is made long to test overflow handling in the table.',
      createdAt: new Date('2024-06-03'),
      analysis:
        'Ready for development phase. All stakeholders have reviewed and approved the designs. This analysis is intentionally verbose to ensure overflow occurs in the table cell.',
