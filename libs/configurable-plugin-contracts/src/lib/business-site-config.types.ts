...
export interface BusinessFeatures {
  ...
  booking: { enabled: boolean; allowOnlinePayment?: boolean };
  clientTasks: { enabled: boolean; allowClientCompletion: boolean };
...
export interface LandingSectionRichContent {
  ...
  themeConfig?: { theme?: 'light' | 'dark'; accentColor?: string };
}
export interface LandingSection {
  ...
  enabled: boolean;
  order: number;
  layoutPlacement?: { split?: SplitLayoutSlot; grid?: GridLayoutSlot };
  body?: string;
  ctaLabel?: string;
  ctaHref?: string;
...
export interface BusinessSiteConfig {
  ...
  plugins: ConfigurablePluginManifest;
