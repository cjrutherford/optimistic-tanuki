export const BillingCommands = {
  ...
  SUBSCRIPTION_CREATE: 'billing.subscriptionCreate',
  SUBSCRIPTION_CREATE_FROM_PRODUCT: 'billing.subscriptionCreateFromProduct',
  SUBSCRIPTION_CANCEL: 'billing.subscriptionCancel',
  SUBSCRIPTION_GET: 'billing.subscriptionGet',
} as const;
