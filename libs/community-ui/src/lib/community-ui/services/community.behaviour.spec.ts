...
const cases: RequestCase[] = [
  ...
  {
    name: 'join posts to the community join route without a body',
    invoke: (service) =>
  ...
  {
    name: 'leave posts to the leave route (was a DELETE 404)',
  ...
  {
    name: 'invite posts the invitee to the community invite route',
    invoke: (service) =>
      service.invite({
        communityId: 'community-1',
    ...
    method: 'POST',
    url: '/api/social/community/community-1/invite',
    body: { inviteeUserId: 'user-3' },
    respondWith: invite,
    expected: invite,
  },
  {
    ...
    method: 'DELETE',
    url: '/api/social/community/invites/invite-1',
    respondWith: null,
    expected: null,
  },
  {
  ...
  {
    name: 'approveMember posts without a body to the approve route',
  ...
  {
    name: 'rejectMember posts without a body to the reject route',
  ...
  {
    name: 'removeMember deletes without a body (payload was never consumed)',
    invoke: (service) =>
  ...
  },
  {
    ...
    method: 'GET',
    url: '/api/profile/by-id/profile-2',
