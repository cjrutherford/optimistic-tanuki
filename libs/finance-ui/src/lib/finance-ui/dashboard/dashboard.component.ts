    ...
    <div class="finance-dashboard">
      ...
      <section class="section">
        ...
        <div class="summary-cards">
          ...
          <div class="card">
            ...
            <p class="count">
              {{ summary()?.metrics?.budgetsAtRiskCount ?? 0 }}
            </p>
          </div>
        </div>
      </section>
      ...
      <section class="section">
        ...
        <div class="coach-grid">
          ...
          <article class="coach-card" [attr.data-severity]="card.severity">
            <p class="coach-kicker">
              {{ card.category }} · {{ card.severity }}
            </p>
            <h2>{{ card.title }}</h2>
            <p>{{ card.message }}</p>
      ...
      <section class="section">
        ...
        <div class="plan-grid">
          ...
          <article class="plan-card">
            <h3>Recurring</h3>
            @if (recurringItems().length) { @for (item of
            recurringItems().slice(0, 3); track item.id) {
