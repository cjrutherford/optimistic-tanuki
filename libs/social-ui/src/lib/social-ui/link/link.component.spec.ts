...
describe('LinkComponent', () => {
  ...
  it('should add a link and emit changes', () => {
    ...
    expect(component.linksChange.emit).toHaveBeenCalledWith({
      all: [testLink],
      added: testLink,
    });
  ...
  it('should remove a link and emit changes', () => {
    const testLink1: LinkType = {
      url: 'http://test1.com',
      title: 'http://test1.com',
    };
    const testLink2: LinkType = {
      url: 'http://test2.com',
      title: 'http://test2.com',
    };
  ...
  it('should not remove a link if it does not exist', () => {
    ...
    const nonExistentLink: LinkType = {
      url: 'http://nonexistent.com',
      title: 'http://nonexistent.com',
    };
