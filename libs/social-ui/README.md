...
- feed, comment, reaction, and social interaction components
- shared models and frontend support code for social workflows

## Documentation

- generated API reference in `ui-playground` (Storybook): `/api/social-ui/index.html`, linked from **Docs → API Reference**
