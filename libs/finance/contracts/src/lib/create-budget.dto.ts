...
export class CreateBudgetDto {
  ...
  @ApiPropertyOptional({
    description: 'The ID of the user creating the budget',
  })
  @IsString()
  @IsUUID()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'The ID of the profile creating the budget',
  })
  @IsString()
  @IsUUID()
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'App scope for the budget' })
  @IsString()
  @IsOptional()
  appScope?: string;
