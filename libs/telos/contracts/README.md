# @optimistic-tanuki/telos-contracts
...
```bash
npm install @optimistic-tanuki/telos-contracts
```

## Usage

```ts
import { ChatMessageDto, MessageType } from '@optimistic-tanuki/telos-contracts';
