...
export ADDITIONAL_DBS=${ADDITIONAL_DBS:-ot_authentication,ot_profile,ot_social,ot_assets,ot_project_planning,ot_chat_collector,ot_telos_docs_service,ot_blogging,ot_permissions,ot_locality,ot_store,ot_app_configurator,ot_forum,ot_finance,ot_wellness,ot_classifieds,classifieds_db,ot_payments,ot_lead_tracker,ot_system_configurator,ot_videos}
