...
The workspace contains customer-facing app products, backend service products, and public package surfaces. Some service capabilities are intended to be offered as hosted products while some library surfaces are intended to be published free through npm via the mirror-repo workflow.
...
| `billing`            | hosted or self-hosted usage metering, usage blocks, and invoice-preview orchestration product surface |
...
| `billing-sdk`       | free npm package surface for billing-service client helpers |
...
| Surface                                       | Role                                                                       |
| --------------------------------------------- | -------------------------------------------------------------------------- |
| `tools/public-packages/public-packages.json`  | allowlist of publishable public package surfaces                           |
| `tools/public-packages/mirror-root/README.md` | documents that mirror repo versioning and npm publishing are authoritative |
| `.github/workflows/sync-public-packages.yml`  | syncs approved package surfaces into the mirror release flow               |
| `.github/workflows/release-packages.yml`      | validates public package boundaries in the source repo                     |
