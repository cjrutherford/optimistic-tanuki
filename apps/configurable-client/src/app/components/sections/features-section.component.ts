...
@Component({
  ...
  styles: [
    `
      ...
      .feature-card {
        padding: 2rem;
        border: 1px solid var(--border, var(--ot-client-section-border));
        border-radius: 8px;
        text-align: center;
        background: var(--surface, var(--ot-client-section-background));
      }
      ...
      p {
        color: color-mix(
          in srgb,
          var(--foreground, var(--ot-client-section-foreground)) 70%,
          transparent
        );
        line-height: 1.6;
      }
