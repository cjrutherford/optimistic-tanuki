import { Injectable, PLATFORM_ID, Inject } from '@angular/core'; // Added PLATFORM_ID, Inject
...
export class ThemeService {
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: object) { // Injected PLATFORM_ID
    const storedTheme = loadTheme(this.platformId); // Pass platformId
  ...
  setTheme(theme: 'light' | 'dark') {
    ...
    saveTheme(this.platformId, theme, this.accentColor); // Pass platformId
  ...
  setAccentColor(color: string) {
    ...
    saveTheme(this.platformId, this._theme, color); // Pass platformId
    this.applyThemeColors();
  }
