...
export class BlogEntity1759696654784 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "contact" ADD CONSTRAINT "FK_d99edaae05074f19fd932717beb" FOREIGN KEY ("blogId") REFERENCES "blog"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "event" ADD CONSTRAINT "FK_10fdd44e2357db4e9a662256ce0" FOREIGN KEY ("blogId") REFERENCES "blog"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "event" DROP CONSTRAINT "FK_10fdd44e2357db4e9a662256ce0"`
    );
    await queryRunner.query(
      `ALTER TABLE "contact" DROP CONSTRAINT "FK_d99edaae05074f19fd932717beb"`
    );
