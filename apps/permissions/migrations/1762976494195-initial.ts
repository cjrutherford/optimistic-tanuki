...
export class Initial1762976494195 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "role_assignment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "profileId" character varying NOT NULL, "targetId" character varying, "roleId" uuid NOT NULL, "appScopeId" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7e79671a8a5db18936173148cb4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_20b82c625ef651c3bd33f73e2b" ON "role_assignment" ("roleId", "profileId", "appScopeId", "targetId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_77d73f6653939bc0f2cb811c2e" ON "permission" ("name", "appScopeId", "targetId") `);
        ...
        await queryRunner.query(`ALTER TABLE "permission" ADD CONSTRAINT "FK_4cfc13bdd261613b91c5f2e23fc" FOREIGN KEY ("appScopeId") REFERENCES "app_scope"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "app_scope_permissions" ADD CONSTRAINT "FK_ddb46c1e8127c19f9223a645b05" FOREIGN KEY ("permission_id") REFERENCES "permission"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "permission" DROP CONSTRAINT "FK_4cfc13bdd261613b91c5f2e23fc"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_77d73f6653939bc0f2cb811c2e"`);
        await queryRunner.query(`DROP TABLE "permission"`);
        await queryRunner.query(`DROP TABLE "role"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_20b82c625ef651c3bd33f73e2b"`);
