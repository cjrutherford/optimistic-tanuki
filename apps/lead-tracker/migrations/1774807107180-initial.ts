...
export class Initial1774807107180 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."lead_flags_reasons_enum" AS ENUM('irrelevant', 'duplicate', 'bad_contact_info', 'wrong_industry', 'spam', 'not_decision_maker', 'company_too_small', 'company_too_large', 'other')`
    );
    await queryRunner.query(
      `CREATE TABLE "lead_flags" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "leadId" uuid NOT NULL, "reasons" "public"."lead_flags_reasons_enum" array NOT NULL, "notes" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6fdc1b208c0fc16e4ed36748989" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."leads_source_enum" AS ENUM('upwork', 'linkedin', 'referral', 'cold', 'local', 'other')`
    );
    await queryRunner.query(
