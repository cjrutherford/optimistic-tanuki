...
describe('TopicsComponent', () => {
  ...
  it('renders the add topic form inside a modal overlay', () => {
    ...
    expect(
      fixture.debugElement.query(By.css('.topic-modal-overlay'))
    ).not.toBeNull();
    expect(
      fixture.debugElement.query(By.css('.topic-modal-shell .add-topic-card'))
    ).not.toBeNull();
  });
  ...
  it('loads a topic into the form for editing and runs discovery after save', () => {
    ...
    component.topicForm.discoveryIntent =
      LeadTopicDiscoveryIntent.SERVICE_BUYERS;
    component.topicForm.sources = [
  ...
  it('shows service-buyer help text when google maps is selected for local business discovery', () => {
    ...
    fixture.componentInstance.openAddForm();
    fixture.componentInstance.topicForm.sources = [
      LeadDiscoverySource.GOOGLE_MAPS,
    ];
    fixture.componentInstance.topicForm.discoveryIntent =
      LeadTopicDiscoveryIntent.SERVICE_BUYERS;
    fixture.detectChanges();
  ...
  it('renders actionable provider diagnostics from discovery results', () => {
    ...
    leadsServiceStub.runTopicDiscovery.mockReturnValue(
      of({
        ...
        status: 'completed',
        message:
          'No matching leads were found. Diagnostics: Google Maps discovery requires an API key.',
        providerResults: [
          {
  ...
  it('renders a structured discovery summary with normalized provider issues', () => {
    ...
    leadsServiceStub.runTopicDiscovery.mockReturnValue(
      of({
        ...
        summaryBody:
          'Google Maps could not run because the API key is missing.',
        actionItems: [
