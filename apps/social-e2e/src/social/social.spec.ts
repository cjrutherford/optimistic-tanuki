...
import { PostCommands, CommentCommands, VoteCommands, AttachmentCommands, FollowCommands } from '@optimistic-tanuki/constants';
...
describe('Social Microservice E2E', () => {
  ...
  describe('Post Operations', () => {
    describe('Create Post', () => {
      it('should create a new post', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: PostCommands.CREATE }, {
            userId: testUserId,
      ...
      it('should create a post without title', async () => {
        ...
        expect(result).toBeDefined();
        expect(result.id).toBeDefined();
        expect(result.content).toBe('Post without title');
      });
    });
    ...
    describe('Find Posts', () => {
      it('should find a post by id', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: PostCommands.FIND }, {
            id: createdPostId,
            options: {},
          })
        );
      ...
      it('should find many posts', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: PostCommands.FIND_MANY }, {
    ...
    describe('Update Post', () => {
      it('should update a post', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: PostCommands.UPDATE }, {
            id: createdPostId,
            data: {
  ...
  describe('Comment Operations', () => {
    describe('Create Comment', () => {
      it('should create a comment on a post', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: CommentCommands.CREATE }, {
    ...
    describe('Find Comments', () => {
      it('should find a comment by id', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: CommentCommands.FIND }, {
            id: createdCommentId,
            options: {},
          })
        );
      ...
      it('should find comments for a post', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: CommentCommands.FIND_MANY }, {
            postId: createdPostId,
          })
        );
    ...
    describe('Update Comment', () => {
      it('should update a comment', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: CommentCommands.UPDATE }, {
            id: createdCommentId,
            data: {
  ...
  describe('Vote Operations', () => {
    describe('Upvote', () => {
      it('should upvote a post', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: VoteCommands.UPVOTE }, {
            id: createdPostId,
            userId: testUserId,
          })
        );
    ...
    describe('Get Votes', () => {
      it('should get votes for a post', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: VoteCommands.GET }, {
            postid: createdPostId,
          })
        );
    ...
    describe('Downvote', () => {
      it('should downvote a post', async () => {
        ...
        await firstValueFrom(
          socialClient.send({ cmd: VoteCommands.UNVOTE }, {
            id: createdVoteId,
          })
        );
        ...
        // Then downvote
        const result = await firstValueFrom(
          socialClient.send({ cmd: VoteCommands.DOWNVOTE }, {
            id: createdPostId,
            userId: testUserId,
          })
        );
  ...
  describe('Follow Operations', () => {
    describe('Follow User', () => {
      it('should follow a user', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: FollowCommands.FOLLOW }, {
    ...
    describe('Get Followers', () => {
      it('should get followers of a user', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: FollowCommands.GET_FOLLOWERS }, {
            followeeId: testUserId2,
          })
        );
    ...
    describe('Get Following', () => {
      it('should get users that a user is following', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: FollowCommands.GET_FOLLOWING }, {
            followerId: testUserId,
          })
        );
    ...
    describe('Get Follower Count', () => {
      it('should get follower count', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: FollowCommands.GET_FOLLOWER_COUNT }, {
            followeeId: testUserId2,
          })
        );
    ...
    describe('Get Following Count', () => {
      it('should get following count', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: FollowCommands.GET_FOLLOWING_COUNT }, {
            followerId: testUserId,
          })
        );
    ...
    describe('Unfollow User', () => {
      it('should unfollow a user', async () => {
        const result = await firstValueFrom(
          socialClient.send({ cmd: FollowCommands.UNFOLLOW }, {
            followerId: testUserId,
            followeeId: testUserId2,
          })
        );
  ...
  describe('Delete Operations', () => {
    it('should delete a comment', async () => {
      const result = await firstValueFrom(
        socialClient.send({ cmd: CommentCommands.DELETE }, {
          id: createdCommentId,
        })
      );
    ...
    it('should delete a post', async () => {
      const result = await firstValueFrom(
        socialClient.send({ cmd: PostCommands.DELETE }, {
          id: createdPostId,
        })
      );
