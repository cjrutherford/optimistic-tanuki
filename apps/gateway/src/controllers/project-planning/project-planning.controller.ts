...
export class ProjectPlanningController {
    ...
    @Post('projects')
    async createProject(@User() user: UserDetails, @Body() createProjectDto: CreateProjectDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: ProjectCommands.CREATE }, { ...createProjectDto, createdBy: user.profileId }));
    }
    ...
    @Patch('projects')
    async updateProject(@User() user: UserDetails, @Body() updateProjectDto: UpdateProjectDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: ProjectCommands.UPDATE }, { ...updateProjectDto, updatedBy: user.profileId }));
    }
    ...
    @Post('changes')
    async createChange(@User() user: UserDetails, @Body() createChangeDto: CreateChangeDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: ChangeCommands.CREATE }, { ...createChangeDto, createdBy: user.profileId }));
    }
    ...
    @Patch('changes')
    async updateChange(@User() user: UserDetails, @Body() updateChangeDto: UpdateChangeDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: ChangeCommands.UPDATE }, { ...updateChangeDto, updatedBy: user.profileId }));
    }
    ...
    @Post('journal')
    async createJournal(@User() user: UserDetails, @Body() createJournalDto: CreateProjectJournalDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: ProjectJournalCommands.CREATE }, { ...createJournalDto, createdBy: user.profileId }));
    }
    ...
    @Patch('journal')
    async updateJournal(@User() user: UserDetails, @Body() updateJournalDto: UpdateProjectJournalDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: ProjectJournalCommands.UPDATE }, { ...updateJournalDto, updatedBy: user.profileId }));
    }
    ...
    @Post('risk')
    async createRisk(@User() user: UserDetails, @Body() createRiskDto: CreateRiskDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: RiskCommands.CREATE }, { ...createRiskDto, createdBy: user.profileId }));
    }
    ...
    @Patch('risk')
    async updateRisk(@User() user: UserDetails, @Body() updateRiskDto: UpdateRiskDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: RiskCommands.UPDATE }, { ...updateRiskDto, updatedBy: user.profileId }));
    }
    ...
    @Post('tasks')
    async createTask(@User() user: UserDetails, @Body() createTaskDto: CreateTaskDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: TaskCommands.CREATE }, { ...createTaskDto, createdBy: user.profileId }));
    }
    ...
    @Patch('tasks')
    async updateTask(@User() user: UserDetails, @Body() updateTaskDto: UpdateTaskDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: TaskCommands.UPDATE }, { ...updateTaskDto, updatedBy: user.profileId }));
    }
    ...
    @Post('timers')
    async createTimer(@User() user: UserDetails, @Body() createTimerDto: CreateTimerDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: TimerCommands.CREATE }, { ...createTimerDto, createdBy: user.profileId }));
    }
    ...
    @Patch('timers')
    async updateTimer(@User() user: UserDetails, @Body() updateTimerDto: UpdateTimerDto) {
        return await firstValueFrom(this.projectPlanningService.send({ cmd: TimerCommands.UPDATE }, { ...updateTimerDto, updatedBy: user.profileId }));
    }
