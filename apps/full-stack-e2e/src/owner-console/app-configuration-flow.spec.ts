...
test.describe('App Configuration Flow', () => {
  ...
  test('should create app config in owner-console and render in configurable-client', async ({
    page,
  }) => {
    ...
    await page
      .locator('.section-item:has-text("Hero Section") .icon-btn[title="Edit"]')
      .click();
    ...
    await page
      .locator('.feature-card:has-text("Social") lib-checkbox input')
      .check();
