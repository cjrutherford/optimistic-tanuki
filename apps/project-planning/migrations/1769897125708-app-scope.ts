...
export class AppScope1769897125708 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "change" ADD "appScope" character varying NOT NULL DEFAULT 'project-planning'`
    );
    await queryRunner.query(
      `ALTER TABLE "project_journal" ADD "appScope" character varying NOT NULL DEFAULT 'project-planning'`
    );
    await queryRunner.query(
      `ALTER TABLE "risk" ADD "appScope" character varying NOT NULL DEFAULT 'project-planning'`
    );
    await queryRunner.query(
      `ALTER TABLE "timer" ADD "appScope" character varying NOT NULL DEFAULT 'project-planning'`
    );
    await queryRunner.query(
      `ALTER TABLE "task" ADD "appScope" character varying NOT NULL DEFAULT 'project-planning'`
    );
    await queryRunner.query(
      `ALTER TABLE "project" ADD "appScope" character varying NOT NULL DEFAULT 'project-planning'`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "project_journal" DROP COLUMN "appScope"`
    );
