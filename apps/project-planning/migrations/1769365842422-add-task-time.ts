...
export class AddTaskTime1769365842422 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "task_note" ADD CONSTRAINT "FK_bc063e055555168bb172b12f36f" FOREIGN KEY ("taskId") REFERENCES "task"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "task_time_entry" ADD CONSTRAINT "FK_36cae699dcb526cc9cccd973bde" FOREIGN KEY ("taskId") REFERENCES "task"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "task_tags" ADD CONSTRAINT "FK_70515bc464901781ac60b82a1ea" FOREIGN KEY ("task_id") REFERENCES "task"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "task_tags" ADD CONSTRAINT "FK_f883135d033e1541f6a81972e7d" FOREIGN KEY ("tag_id") REFERENCES "task_tag"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "task_time_entry" DROP CONSTRAINT "FK_36cae699dcb526cc9cccd973bde"`
    );
    await queryRunner.query(
      `ALTER TABLE "task_note" DROP CONSTRAINT "FK_bc063e055555168bb172b12f36f"`
    );
    await queryRunner.query(
