...
describe('ProjectTelosService', () => {
  ...
  beforeEach(async () => {
    ...
    projectRepository = module.get<Repository<ProjectTelos>>(
      getRepositoryToken(ProjectTelos)
    );
    ...
    jest
      ...
      .mockImplementation((entity) =>
        Object.assign(new ProjectTelos(), entity)
      );
    jest
      .spyOn(projectRepository, 'save')
      .mockImplementation(async (entity) => entity as ProjectTelos);
