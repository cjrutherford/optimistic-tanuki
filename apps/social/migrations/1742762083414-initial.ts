...
export class Initial1742762083414 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "vote" ("id" SERIAL NOT NULL, "value" integer NOT NULL, "userId" character varying NOT NULL, "profileId" character varying NOT NULL, "postId" uuid, "commentId" uuid, CONSTRAINT "PK_2d5932d46afe39c8176f9d4be72" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "link" ("id" SERIAL NOT NULL, "url" character varying NOT NULL, CONSTRAINT "PK_26206fb7186da72fbb9eaa3fac9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."attachment_type_enum" AS ENUM('IMAGE', 'VIDEO', 'AUDIO', 'DOCUMENT')`
    );
    await queryRunner.query(
      `CREATE TABLE "attachment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "filePath" character varying NOT NULL, "type" "public"."attachment_type_enum" NOT NULL DEFAULT 'IMAGE', "postId" uuid, CONSTRAINT "PK_d2a80c3a8d467f08a750ac4b420" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "vote" ADD CONSTRAINT "FK_ad37adcff60fdb9670a97868ab1" FOREIGN KEY ("commentId") REFERENCES "comment"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "attachment" ADD CONSTRAINT "FK_09f5bc45017ed4f20ad606985a0" FOREIGN KEY ("postId") REFERENCES "post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "attachment" DROP CONSTRAINT "FK_09f5bc45017ed4f20ad606985a0"`
    );
    await queryRunner.query(
