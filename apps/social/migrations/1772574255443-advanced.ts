...
export class Advanced1772574255443 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."activity_type_enum" AS ENUM('post', 'comment', 'like', 'share', 'follow', 'mention')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_dca8e368c8036ec68982af9bad" ON "activity" ("profileId", "createdAt") `
    );
    await queryRunner.query(
      `CREATE TYPE "public"."saved_item_itemtype_enum" AS ENUM('post', 'comment')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_53debe423b26554a3df7349128" ON "search_history" ("profileId", "query") `
    );
    await queryRunner.query(
      `CREATE TYPE "public"."chat_message_type_enum" AS ENUM('chat', 'info', 'warning', 'system')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."event_privacy_enum" AS ENUM('public', 'private', 'community')`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."event_status_enum" AS ENUM('draft', 'published', 'cancelled', 'completed')`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_dca8e368c8036ec68982af9bad"`
    );
