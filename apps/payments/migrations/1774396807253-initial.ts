...
export class Initial1774396807253 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_b37667129241edaa0b214cf439" ON "payout_requests" ("status") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b44f529526989bf04785a6e310" ON "payout_requests" ("sellerId") `
    );
    await queryRunner.query(
      `CREATE TABLE "lemon_squeezy_products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "appScope" character varying NOT NULL, "tier" character varying NOT NULL, "lemonSqueezyProductId" character varying NOT NULL, "lemonSqueezyVariantId" character varying, "name" character varying, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_676048da91b1516260ab33ade8e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e34aca5b27dcfa68780034901c" ON "lemon_squeezy_products" ("lemonSqueezyProductId") `
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_36ddcb5b1323403a4d7637b062" ON "lemon_squeezy_products" ("appScope", "tier") `
    );
    await queryRunner.query(
      `ALTER TABLE "business_themes" ADD CONSTRAINT "FK_bb4faefcea416c92611f911e362" FOREIGN KEY ("businessPageId") REFERENCES "business_pages"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "business_themes" DROP CONSTRAINT "FK_bb4faefcea416c92611f911e362"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_36ddcb5b1323403a4d7637b062"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e34aca5b27dcfa68780034901c"`
    );
    await queryRunner.query(`DROP TABLE "lemon_squeezy_products"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b44f529526989bf04785a6e310"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b37667129241edaa0b214cf439"`
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ab67a206c9cfc33206808dea33"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_31bca9f7753201479da158d51a"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_92de52b4c607bdf9b4f64f4001"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_434239966cb60e2dbc6178f993"`
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7415760570c120829c72b4f5b8"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a5d9802113479c364684753727"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c2b2163d45968c12d67dd5233b"`
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_872b81d3b1334bc1fedc74ffd8"`
    );
    await queryRunner.query(`DROP TABLE "business_pages"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ee0cb3c302733279a221ee4e16"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fcf4b3bab2a5824e3609bb095c"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e0f22c9d24085d55712862965a"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_915364e7c63b446c464604a111"`
    );
    await queryRunner.query(`DROP TABLE "classified_payments"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cfd5edc39019b9001bd86e90f7"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fe29212b06774a67d6f693662e"`
    );
