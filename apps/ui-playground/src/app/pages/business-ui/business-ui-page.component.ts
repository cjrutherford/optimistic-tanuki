...
@Component({
  selector: 'pg-business-ui-page',
  standalone: true,
  imports: [CommonModule, PageShellComponent, IndexChipComponent],
  template: `
    <pg-page-shell
      packageName="@optimistic-tanuki/business-ui"
      title="Business UI"
...
export class BusinessUiPageComponent {
  readonly importSnippet = `import { BusinessCardComponent, ... } from '@optimistic-tanuki/business-ui';`;
  readonly components = [
    {
      id: 'business-card',
      name: 'BusinessCardComponent',
      selector: 'otui-business-card',
      description:
        'Card for displaying business listings with contact info, hours, and actions.',
    },
  ];
}
