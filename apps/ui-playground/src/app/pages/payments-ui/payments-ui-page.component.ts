...
@Component({
  selector: 'pg-payments-ui-page',
  standalone: true,
  imports: [CommonModule, PageShellComponent, IndexChipComponent],
  template: `
    <pg-page-shell
      packageName="@optimistic-tanuki/payments-ui"
      title="Payments UI"
...
export class PaymentsUiPageComponent {
  readonly importSnippet = `import { PaymentMethodSelectorComponent, ... } from '@optimistic-tanuki/payments-ui';`;
  readonly components = [
    {
      id: 'payment-method-selector',
      name: 'PaymentMethodSelectorComponent',
      selector: 'otui-payment-method-selector',
      description:
        'Component for selecting payment methods (card, PayPal, etc.) with saved options.',
    },
    {
      id: 'payment-form',
      name: 'PaymentFormComponent',
      selector: 'otui-payment-form',
      description: 'Secure payment form with card input and validation.',
    },
    {
      id: 'transaction-history',
      name: 'TransactionHistoryComponent',
      selector: 'otui-transaction-history',
      description: 'List of past transactions with filtering and export.',
    },
  ];
}
