...
@Component({
  selector: 'pg-classified-ui-page',
  standalone: true,
  imports: [CommonModule, PageShellComponent, IndexChipComponent],
  template: `
    <pg-page-shell
      packageName="@optimistic-tanuki/classified-ui"
      title="Classifieds UI"
...
export class ClassifiedUiPageComponent {
  readonly importSnippet = `import { ClassifiedCardComponent, ... } from '@optimistic-tanuki/classified-ui';`;
  readonly components = [
    {
      id: 'classified-card',
      name: 'ClassifiedCardComponent',
      selector: 'otui-classified-card',
      description:
        'Card for displaying classified ads with price, images, and contact options.',
    },
  ];
}
