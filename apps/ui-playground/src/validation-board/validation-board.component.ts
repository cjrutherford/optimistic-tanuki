...
/**
 * One representative component from each UI library on a single page, so a
 * personality or mode change can be checked across the whole estate at once.
 */
@Component({
  selector: 'pg-validation-board',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  styles: [
    `
      ...
      .validation-card {
        ...
        padding: var(--personality-card-padding, 16px);
