...
export class Initial1770152975983 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'FK_2edd2d5b91d15d5262356ab2a5b'
        ) THEN
          ALTER TABLE "video"
          ADD CONSTRAINT "FK_2edd2d5b91d15d5262356ab2a5b"
          FOREIGN KEY ("channelId") REFERENCES "channel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
        END IF;
      END $$;
    `);
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'FK_8ce6427ce49d80b46235eb6d554'
        ) THEN
          ALTER TABLE "channel_subscription"
          ADD CONSTRAINT "FK_8ce6427ce49d80b46235eb6d554"
          FOREIGN KEY ("channelId") REFERENCES "channel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
        END IF;
      END $$;
    `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "channel_subscription" DROP CONSTRAINT "FK_8ce6427ce49d80b46235eb6d554"`,
    );
    await queryRunner.query(
      `ALTER TABLE "video" DROP CONSTRAINT "FK_2edd2d5b91d15d5262356ab2a5b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "video_view" DROP CONSTRAINT "FK_86d596e576b782c3e486327dfcf"`,
    );
