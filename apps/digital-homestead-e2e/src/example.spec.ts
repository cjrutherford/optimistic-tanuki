...
test.describe('Digital Homestead E2E Tests', () => {
  ...
  test.describe('Blog Page - Unauthenticated User (Read-Only)', () => {
    ...
    test('should NOT show "New Post" button for unauthenticated user', async ({ page }) => {
      await page.goto('/blog');
      await page.waitForLoadState('networkidle');
    ...
    test('should display welcome message with sign-in link', async ({ page }) => {
      await page.goto('/blog');
      await page.waitForLoadState('networkidle');
    ...
    test('should NOT show "Edit Post" button for unauthenticated user', async ({ page }) => {
      await page.goto('/blog');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Blog Page - Accessibility', () => {
    ...
    test('should have semantic HTML structure', async ({ page }) => {
      ...
      const main = page.locator('main.blog-content');
