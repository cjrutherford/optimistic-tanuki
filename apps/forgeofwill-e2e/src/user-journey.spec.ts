...
test.describe('User Journey', () => {
  ...
  test('should register, login, and update profile', async ({ page }) => {
    ...
    await page.click('otui-button[type="submit"], otui-button:has-text("adventure")', { force: true });
    ...
    await page.locator('lib-image-upload input[type="file"]').first().setInputFiles('apps/forgeofwill-e2e/src/test-image.png');
