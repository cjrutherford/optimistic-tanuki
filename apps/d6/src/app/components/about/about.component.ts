    ...
    <div class="about-container">
      ...
      <div class="content-grid">
        <otui-card class="content-card">
          ...
          <p>
            A Daily 6 is a set of six tasks to complete each day, while a Daily
            4 is a shorter version with just four tasks. Both are designed to
            build a pattern of self-compassion, mindfulness, and emotional
            resilience. They exercise your ability to reflect on your day in a
            structured, non-judgemental, and supportive way.
          </p>
        </otui-card>
        ...
        <otui-card class="content-card">
          ...
          <p>
            The Daily Six or Four prompts are derived from DBT techniques and
            are designed for those seeking to enhance their emotional awareness
            and resilience. By engaging with these prompts, individuals can
            cultivate a deeper understanding of their thoughts and feelings,
            ultimately leading to more effective coping strategies and a greater
            sense of well-being.
          </p>
        </otui-card>
        ...
        <otui-card class="content-card">
          ...
          <p>
            ...
            their emotions, cope with stress, and improve their relationships.
            It was originally developed to treat borderline personality disorder
            but has since been adapted for use with a variety of mental health
            issues.
          </p>
        </otui-card>
        ...
        <otui-card class="content-card">
          ...
          <ul>
            ...
            <li>
              <strong>Non-Judgement:</strong> Practice observing your thoughts
              in a non-judgemental way by reframing the judgement prompt.
            </li>
            <li>
